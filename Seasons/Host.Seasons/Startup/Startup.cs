        ...
        public static IEnumerable<IDomainEvent> Seeds
        {
            get
            {
                var created = new SeasonCreated(
                    Guid.Create(new Guid("7A097EAE-BE35-4B4D-A23D-98A6B57534F3")),
                    "Gestartete Season",
                    DateTimeOffset.Now);
                ...
                {
                    TeamId = Guid.Create(new Guid("2798435C-9C72-4ECE-BD7D-00BECBACCED7"))
                });
                var addTeam2 = season.AddTeam(new TeamReadModel
                {
                    TeamId = Guid.Create(new Guid("406D35EE-421A-4D45-9F34-1834D5ACD215"))
                });
                var addTeam3 = season.AddTeam(new TeamReadModel
                {
                    TeamId = Guid.Create(new Guid("772F7E84-4237-4634-AF85-5C0D72FF8DBD"))
                });
                var addTeam4 = season.AddTeam(new TeamReadModel
                {
                    TeamId = Guid.Create(new Guid("38C41447-21F6-4941-BD7E-AC97EF866197"))
                });
                ...
                var created2 = new SeasonCreated(
                    Guid.Create(new Guid("BF1EAEB0-34A6-4146-92FA-141806F5B8B1")),
                    "Frische Season",
                    DateTimeOffset.Now);
                ...
                {
                    TeamId = Guid.Create(new Guid("D5BB0FDA-BBE5-4271-8311-460AE5AD3DDA"))
                });
